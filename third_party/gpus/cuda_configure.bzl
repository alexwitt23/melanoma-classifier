...
def _create_local_cuda_repository(repository_ctx):
    ...
    find_cuda_config_script = repository_ctx.path(Label("@melanoma_classifier//third_party/gpus:find_cuda_config.py.gz.base64"))
    ...
    check_cuda_libs_script = repository_ctx.path(Label("@melanoma_classifier//third_party/gpus:check_cuda_libs.py"))
